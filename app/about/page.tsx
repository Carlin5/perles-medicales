      ...
      <div className="grid gap-12 md:grid-cols-12 md:gap-16">
        ...
        <Reveal delay={0.1} className="md:col-span-7 space-y-5 text-lg text-navy/75 leading-relaxed">
          <p>
            ...
            who graduated from MUST in 2003 and then pursued separate career
            paths across clinical practice, research, public health, and
            industry. In 2021 they reconnected to pool resources and formalize
            collective investment, evolving into a structured and strategic
            investment group with a shared long-term vision.
          </p>
          <p>
